                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          const selectedApt = allApartments.find(
                            (apt) => apt.ApartmentID === openHouse.apartmentId
                          );
                  ...
                  <View style={styles.cardDetails}>
                    <View style={styles.timeContainer}>
                      ...
                      <Text style={styles.timeText}>
                        {formatTime(openHouse.startTime)} -{" "}
                        {formatTime(openHouse.endTime)}
                      </Text>
                    </View>
                    ...
                    <View style={styles.participantsContainer}>
                      ...
                      <Text style={styles.participantsText}>
                        {openHouse.totalRegistrations}/
                        {openHouse.amountOfPeoples} משתתפים
                      </Text>
                    </View>
                  </View>
